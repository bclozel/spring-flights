...
public class UserProfilesInitializer {
	...
	public void createDefaultProfiles() {
		...
		UserProfile rossen = new UserProfile("rossen", "Rossen Stoyanchev", "rstoyanchev@pivotal.io",
		...
		UserProfile rob = new UserProfile("rob", "Rob Winch", "rwinch@pivotal.io",
		...
		UserProfile brian = new UserProfile("brian", "Brian Clozel", "bclozel@pivotal.io",
