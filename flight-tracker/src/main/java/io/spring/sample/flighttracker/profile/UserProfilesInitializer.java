...
public class UserProfilesInitializer {
	...
	public void createDefaultProfiles() {
		...
		UserProfile rossen = new UserProfile("rossen", "Rossen Stoyanchev", "rossen@example.com",
		...
		UserProfile rob = new UserProfile("rob", "Rob Winch", "rob@example.com",
		...
		UserProfile brian = new UserProfile("brian", "Brian Clozel", "brian@example.com",
