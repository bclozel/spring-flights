            ...
            .then(data => {
                ...
                this.trackerClient
                    ...
                    .subscribe({
                        ...
                        onNext: msg => {
                            this.backpressureCtrl.decreaseCurrentDemand();
                            const data = msg.data;
...
L.Control.BackpressureCtrl = L.Control.extend({
    ...
    onAdd: function(map) {
        ...
        window.setInterval(() => {
            ...
            let maxDemand = Number.parseInt(input.value);
            if (this.subscription && currentDemand < maxDemand) {
                this.subscription.request(maxDemand - currentDemand);
                this.currentDemand+= maxDemand - currentDemand;
            }
        }, 1000);
        return field;
    },
